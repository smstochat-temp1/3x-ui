...
export const PiaBindingViewSchema = z.object({
  active: z.boolean(),
...
export type PiaBindingView = z.infer<typeof PiaBindingViewSchema>;

export const PiaCatalogStatusViewSchema = z.object({
...
export type PiaCatalogStatusView = z.infer<typeof PiaCatalogStatusViewSchema>;

export const PiaDependencyViewSchema = z.object({
  field: z.string(),
  kind: z.string(),
  label: z.string(),
});
export type PiaDependencyView = z.infer<typeof PiaDependencyViewSchema>;

export const PiaEgressViewSchema = z.object({
  binding: z.lazy(() => PiaBindingViewSchema).nullable().optional(),
  enabled: z.boolean(),
  generation: z.number().int(),
  hasActiveBinding: z.boolean(),
  ipv6Policy: z.string(),
  keepaliveSeconds: z.number().int(),
  lastErrorCode: z.string(),
  lastErrorMessage: z.string(),
  lastExternalIp: z.string(),
  lastLatencyMs: z.number().int(),
  mtu: z.number().int(),
  name: z.string(),
  outboundTag: z.string(),
  peerIp: z.string(),
...
export type PiaEgressView = z.infer<typeof PiaEgressViewSchema>;

export const PiaErrorInfoSchema = z.object({
  code: z.string(),
  details: z.unknown().optional(),
  operationId: z.string().optional(),
  retryable: z.boolean(),
});
export type PiaErrorInfo = z.infer<typeof PiaErrorInfoSchema>;

export const PiaProfileViewSchema = z.object({
  accountHint: z.string(),
  authStatus: z.string(),
  enabled: z.boolean(),
  hasToken: z.boolean(),
  lastAuthErrorCode: z.string(),
  lastAuthErrorMessage: z.string(),
  lastAuthenticatedAt: z.number().int(),
  name: z.string(),
  revision: z.number().int(),
  tokenExpiresAt: z.number().int(),
  uid: z.string(),
});
export type PiaProfileView = z.infer<typeof PiaProfileViewSchema>;

export const PiaRegionViewSchema = z.object({
  countryCode: z.string(),
  id: z.string(),
  name: z.string(),
  serverCount: z.number().int(),
});
export type PiaRegionView = z.infer<typeof PiaRegionViewSchema>;

export const PiaServerViewSchema = z.object({
  hostname: z.string(),
  ip: z.string(),
});
...
export type PiaStatusView = z.infer<typeof PiaStatusViewSchema>;
