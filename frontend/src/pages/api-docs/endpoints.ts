    ...
    endpoints: [
      ...
      },
      {
        ...
        params: [
          ...
          { name: 'username', in: 'body (form)', type: 'string', desc: 'Required when action=reg.' },
          { name: 'password', in: 'body (form)', type: 'string', desc: 'Required when action=reg.' },
          { name: 'countryCode', in: 'body (form)', type: 'string', desc: 'Required when action=servers.' },
          { name: 'hostname', in: 'body (form)', type: 'string', desc: 'Required when action=addKey.' },
        ],
      },
      {
        method: 'POST',
